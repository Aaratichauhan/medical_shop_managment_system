				...
				<div class="row">
					...
					if (isset($_POST['add'])) {
						...
						if (mysqli_query($conn, $sql)) {
							echo "<p style='font-size:8; text-align:right;'>Medicine details successfully added!</p>";
						} else {
							echo "<p style='font-size:8; text-align:right; color:red;'>Error! Check details.</p>";
						}
					}
